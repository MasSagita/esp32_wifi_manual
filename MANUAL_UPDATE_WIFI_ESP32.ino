...
#define FIREBASE_HOST "esp32dht22-b2db7-default-rtdb.firebaseio.com"
#define FIREBASE_Authorization_key "vgEYaGtz2CTQW3kTkd8XiDo4AmHPLKNgBiUEfSeo"
...
void loop() {
  ...
  if ((WiFi.status() == WL_CONNECTED))  {
    ...
    if (count_send < 200) digitalWrite(led_pin, 1);
    if (count_send > 200) digitalWrite(led_pin, 0);
  }
  else  {
  }
